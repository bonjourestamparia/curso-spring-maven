...
INSERT INTO `categoria` VALUES (1,'Informática'),(2,'Escritório'),(3,'Cama, mesa e banho'),(4,'Infantil'),(5,'Automotivo'),(6,'Ferramentas'),(7,'Vestuário'),(8,'Alimentos'),(9,'Jogos'),(10,'Saúde');
...
INSERT INTO `cidade` VALUES (1,1,'Uberlândia'),(2,2,'São Paulo'),(2,3,'Campinas');
...
INSERT INTO `cliente` VALUES (1,1,'55555','maria@gmail.com','Maria Silva');
...
INSERT INTO `endereco` VALUES (1,1,1,'Jardim','5555','Ap 303','Rua FLores','300'),(2,1,2,'Centro','58778','Sala 800','Avenida Matos','105');
...
INSERT INTO `pagamento_com_boleto` VALUES (2,'2017-10-20 00:00:00.000000',NULL);
...
INSERT INTO `pedido` VALUES (1,1,1,'2017-09-30 10:32:00.000000'),(1,2,2,'2017-10-10 19:35:00.000000');
...
INSERT INTO `produto` VALUES (1,2000,'Computador'),(2,800,'Impressora'),(3,80,'Mouse'),(4,300,'Mesa de Escritório'),(5,50,'Toalha'),(6,200,'Colcha'),(7,1200,'TV true color'),(8,800,'Roçadeira'),(9,100,'Abajour'),(10,180,'Pendente'),(11,90,'Shampoo');
...
INSERT INTO `produto_categoria` VALUES (1,1),(4,1),(1,2),(2,2),(4,2),(1,3),(4,3),(2,4),(3,5),(3,6),(4,7),(5,8),(6,9),(6,10),(7,11);
...
INSERT INTO `telefone` VALUES (1,'5555'),(1,'9999');
...
-- Dump completed on 2023-08-02 22:27:32
