...
public class CursoSpringMavenApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat8 = new Categoria(null, "Alimentos");
		Categoria cat9 = new Categoria(null, "Jogos");
		...
		repo.saveAll(Arrays.asList(cat1, cat2, cat3, cat4, cat5, cat6, cat7, cat8, cat9, cat10));
